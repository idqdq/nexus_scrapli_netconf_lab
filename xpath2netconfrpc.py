...
xpath = "/System/evpn-items/adminSt=enabled/bdevi-items/BDEvi-list/encap=vxlan-10010/rd=rd:unknown:0:0/rttp-items/RttP-list/type=export/ent-items/Rtt-Entry-list/rtt=route-target:unknown:0:0"

ppxml(xpath2xml(xpath, xmlns='blabla'))
